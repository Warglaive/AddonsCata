...
L["Output Frame"] = "출력 창"
L["Right-Click for more options."] = "우-클릭으로 추가 옵션을 표시합니다."
...
L["Standalone options"] = "독립형 옵션"
L["Toggle debugging for %s."] = "%s 디버그 토글."
...
L["Enable right-click menu"] = "우-클릭 메뉴 사용"
L["Enable %s"] = "%s 사용"
...
L["Icon Cooldown Frame"] = "아이콘 쿨다운 프레임"
...
L["Show the standard unit menu when right-clicking on a frame."] = "창에 우-클릭하면 기본 유닛 메뉴를 표시합니다."
...
L["Toggle center icon's cooldown frame."] = "중앙 아이콘에 쿨다운 프레임을 표시합니다."
...
L["Alt-Click to permanantly hide this tab."] = "알트-클릭으로 이 탭을 영구적으로 숨깁니다."
...
L["Use the 40 Player Raid layout when in a raid group outside of a raid instance, instead of choosing a layout based on the current Raid Difficulty setting."] = "현재 공격대 난이도 설정에 따른 배치를 선택하는 대신, 공격대 인스턴스가 아닌 외부 공격대 그룹일 경우 40인 배치를 사용합니다."
...
L["<buff name>"] = "<버프 이름>"
L["Buff: %s"] = "버프: %s"
L["Change what information is shown by the status color."] = "상태 색상에 어떤 정보를 표시할 지 변경합니다."
...
L["Color"] = "색상"
L["Color to use when the %s is above the high count threshold values."] = "%s|1이;가; 높음 수치 값보다 클 때 사용할 색상을 설정합니다."
L["Color to use when the %s is between the low and high count threshold values."] = "%s|이;가; 낮음 값과 높음 값 사이일 때 사용할 색상을 설정합니다."
L["Color when %s is below the low threshold value."] = "%s|1이;가; 낮음 수치 값보다 작을 때 사용할 색상을 설정합니다."
...
L["Debuff: %s"] = "디버프: %s"
L["Debuff type: %s"] = "디버프 유형: %s"
L["Disease"] = "질병"
L["Display status only if the buff is not active."] = "버프가 사라졌을 때만 표시합니다."
L["Display status only if the buff was cast by you."] = "자신이 시전한 버프만 표시합니다."
L["Ghost"] = "유령"
L["High color"] = "높음 색상"
...
L["Remove an existing buff or debuff status."] = "기존의 버프 또는 디버프 상태를 삭제합니다."
L["Remove Aura"] = "오라 삭제"
...
Beginning users may wish to leave this disabled until you are more familiar with Grid, to avoid being overwhelmed by complicated options menus.]=] ] = [=[버프 및 디버프 상태에 대한 상세한 옵션을 표시합니다.
...
L["FD"] = "죽척"
L["Feign Death warning"] = "죽은 척 하기 경고"
L["Health"] = "생명력"
