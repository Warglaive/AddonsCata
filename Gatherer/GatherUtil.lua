--[[
	...
	Version: 3.3.0 (<%codename%>)
	Revision: $Id: GatherUtil.lua 941 2012-08-09 02:14:27Z Esamynn $
...
Gatherer_RegisterRevision("$URL: http://svn.norganna.org/gatherer/trunk/Gatherer/GatherUtil.lua $", "$Rev: 941 $")
...
function Gatherer.Util.DumpAll()
	...
	for _, continent in Gatherer.Storage.GetAreaIndices() do --continents
		for _, zone in Gatherer.Storage.GetAreaIndices(continent) do
			for _, gatherName, gtype in Gatherer.Storage.ZoneGatherNames(continent, zone) do
