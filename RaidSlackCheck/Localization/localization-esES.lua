...
function rsclocalel()
	...
	rsczonereport2 = "El addon ahora se activará en la/las zona(s):" -- Needs review
	...
	rsczonereport8 = "|cffff0000Error!|r ¡La zona actual no se encontró en la lista!" -- Needs review
