...
function rsclocalel()
	...
	rscflasktext1part2 = "Buff wird nicht berücksichtigt, wenn Dauer weniger als |cffff0000%s|r min." -- Needs review
	...
	rsclocnotinc = "vor dem Kampf" -- Needs review
	...
	rsctablereptxt3 = "Berichte, wenn jemand einen Repbot aufstellt" -- Needs review
	rsctablereptxt4 = "Berichte, wenn jemand einen Seelenbrunnen aufstellen will" -- Needs review
	rsctableused1 = "hat ein Festmahl zubereitet!"
	rsctableused2 = "hat einen Kessel mit Fläschchen aufgestellt!" -- Needs review
	rsctableused3 = "hat einen Repbot aufgestellt!" -- Needs review
	rsctableused4 = "will einen Seelenbrunnen aufstellen!" -- Needs review
