...
L.damage_absorb = "A: %s"
L.damage_block = "B: %s"
L.damage_melee = "Nahkampf"
L.damage_critical = "Kritisch"
L.unknown = "Unbekannt"
...
L.config_limit_desc = "How many deaths should be reported per combat session?" -- Needs translation
L.config_history_desc = "How many damage events should be reported per person?" -- Needs translation
