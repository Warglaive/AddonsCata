...
L.damage_absorb = "A: %s"
L.damage_block = "B: %s"
L.damage_melee = "Mêlée"
L.damage_critical = "Critique"
L.unknown = "Inconnu"

-- Error Messages
L.error_report = "(%s) Le rapport n'a pas pu être envoyé car il a dépassé la limite des 255 caractères. Pour corriger ceci, tapez |cffff9900/fatality|r et, soit vous diminuez l'option 'Historique des évènements,' soit sélectionnez '"..QUICKBUTTON_NAME_SELF.."' dans 'Sortie'"
...
L.config_icons_desc = "Inclure les dommages résistés"
