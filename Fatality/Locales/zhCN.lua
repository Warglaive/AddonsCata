...
L.config_output_raid = "输出报告（团队副本）"
L.config_output_party = "输出报告（小队副本）"

-- Configuration: Description
L.config_promoted_desc = "拥有权限才发布信息 ["..RAID_LEADER.."/"..RAID_ASSISTANT.."]"
L.config_lfr_desc = "在随机副本中启用"
